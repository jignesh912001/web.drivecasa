...
export const ENCRYPT_KEY_1 = "c2libGktcGlraW5p";
export const ENCRYPT_KEY_2 = "cmFqYXJhbmNoaG9k";
export const ENCRYPT_KEY_3 = "U2hyZWVLcmlzaG5h";
...
export const PATH_BEFORE_LOGIN = paths.auth.jwt.login; // as '/login'
